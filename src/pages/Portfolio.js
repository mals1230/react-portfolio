...
import takeahike from "./takeahike.png"
    ...
    <div>
      <div className="flex-row justify-center mb-3">
        <Card className="flex-row justify-center col-12 col-md-4 mb-3 p-3">
          ...
          <img className="flex-row justify-center col-12" src={eff} alt="Event Fan Follow" height="150"
          />
        ...
        <Card className="flex-row justify-center col-12 col-md-4 mb-3 p-3">
          ...
          <img className="flex-row justify-center col-12" src={bookclub} alt="Book Club" height="150"
          />
        ...
        <Card className="flex-row justify-center col-12 col-md-4 mb-3 p-3">
          ...
          <img className="flex-row justify-center col-12" src={takeahike} alt="Take A Hike" height="150"
          />
        ...
        <Card className="flex-row justify-center col-12 col-md-4 mb-3 p-3">
          ...
          <img className="flex-row justify-center col-12" src={scheduler} alt="Work Day Scheduler" height="150"
          />
        ...
        <Card className="flex-row justify-center col-12 col-md-4 mb-3 p-3">
          ...
          <img className="flex-row justify-center col-12" src={codequiz} alt="Code Quiz" height="150"
          />
